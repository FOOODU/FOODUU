    ...
    <footer className="p-4 bg-primary sm:p-6 w-full">
        ...
        <motion.div  whileHover={{ rotate: [0, -10, 10, -10, 0] }} className="mb-3 md:mb-0">
          <Link to="/" className="flex gap-8 items-center">
            <motion.img
              ...
              src={Logo}
              className="w-13 md:w-36 object-contain"
              alt="Logo"
            />
          </Link>
        </motion.div>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        ...
        <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.youtube.com/@fooduofficials"
          ...
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.instagram.com/fooduofficial/"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsInstagram />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://twitter.com/fooduofficials"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsTwitter />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.facebook.com/Fooduoffical"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsFacebook />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://in.linkedin.com/company/fooduofficial"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsLinkedin />
          </motion.a>
