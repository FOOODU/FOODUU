  ...
  return (
    <div className="py-2 flex-1 flex flex-col items-start justify-center gap-3">
      ...
      <p className="text-[2rem] lg:text-[4rem] font-bold tracking-wide text-headingColor">
        ...
        <span className="text-orange-600 text-[2.5rem] lg:text-[4.6rem]"> FOODU</span>
      </p>
      <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
      A Gastronomic Adventure Where Every Bite Rewards You! Savor Flavorful Delights, Earn Exciting Rewards, and Play a Part in Nourishing Lives. Join Our Culinary Revolution – It's More Than a Meal, It's a Movement
      </p>
      <motion.button
